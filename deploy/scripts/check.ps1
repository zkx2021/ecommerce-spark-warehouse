...
Assert-FileContains "README.md" "Project acceptance" "README links final acceptance document"
Assert-FileContains "README.md" "Demo runbook" "README links demo runbook"
Assert-FileContains "README.md" "20260720-190621" "README includes latest validation run"
Assert-FileContains "README.md" "Crawler -> Local raw/processed files -> HDFS -> Hive ODS" "README documents end-to-end data flow"
